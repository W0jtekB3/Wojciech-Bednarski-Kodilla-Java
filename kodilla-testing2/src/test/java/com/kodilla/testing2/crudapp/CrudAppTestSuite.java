...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://W0jtekB3.github.io";
    ...
    private void removeTaskFromCrudApp(String taskName) throws InterruptedException {
        // Refresh page to make sure the UI is up-to-date
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                ...
                .forEach(theForm -> {
                    WebElement deleteButton = theForm.findElement(By.xpath(".//button[contains(@class, \"task-delete\")]"));
                    deleteButton.click();
                });
    ...
    @Test
    public void shouldCreateAndRemoveTrelloCard() throws InterruptedException {
        String taskName = createCrudAppTestTask();
        sendTestTaskToTrello(taskName);
        assertTrue(checkTaskExistsInTrello(taskName));   // Verify task is in Trello
        removeTaskFromCrudApp(taskName); // Remove task from CRUD App
    }
}